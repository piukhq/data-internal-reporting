...
layout = dbc.Container([
    ...
    dbc.Row(
        generate_headers(total_user_headline)
    ),
    ...
    dbc.Row(
        generate_headers(df_LC_PLL_totals)
    ),
...
def update_graph(start_date, end_date, channel):
    ...
    return lc_fig_bar, lc_fig_pie, lc_bar_title, lc_pie_title, fig_lin_ua, ua_line_title, pc_fig_pie, pc_pie_title    #This is what is being returned to the outputs in the callbacks 2 outputs = 2 returns
# %%
